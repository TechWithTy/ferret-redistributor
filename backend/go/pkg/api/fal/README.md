# Fal.ai Go SDK (Social Scale Edition)

Thin wrapper around Fal.ai's queue API so Social Scale services can launch AI workflows, poll for completion, and stream progress without re-implementing the HTTP plumbing each time.
