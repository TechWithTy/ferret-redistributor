...
This package wraps our local `backend/typescript/editly` workspace to provide a single entry point for creating or iterating on video experiments.

### Setup

```bash
cd backend/typescript/tools
pnpm install
```
